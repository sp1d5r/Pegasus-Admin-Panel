...
class Course extends Component {
    ...
    render() {
        return (
            <a href={'/course/'+this.props.courseID} style={{height: '95%', flex: '0 0 20%', float: 'left', margin: '10px', backgroundColor: this.state.color, color: 'inherit', textDecoration: 'none', borderRadius:10}}>
                <div style={{height: '70%'}}>
